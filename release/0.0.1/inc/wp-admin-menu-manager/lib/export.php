 ...
 */
function wpamm_export_wp($postToGet, $args = array()) {
	global $wpdb, $post;
	 ...
	 */
	do_action('wpamm_export_wp', $args);

	$sitename = sanitize_key( get_bloginfo( 'name' ) );
	if ( ! empty($sitename) ) $sitename .= '.';
	$filename = "menu-setup-id-{$postToGet}" . '.xml';
	...
	$post_ids = array($postToGet); //$wpdb->get_col( "SELECT ID FROM {$wpdb->posts} $join WHERE $where" );
